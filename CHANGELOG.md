...
- `@airp/editor-core`: Machine Handle addressing (`indexDocumentAtIds`, JSON Pointer helpers), write-back serialization, and schema-derived block shapes (`readBlockShape`, `listBlockTypes`), as the base for host-side editing
