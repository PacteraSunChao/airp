 ...
 */
export function citationItemsHtml110(items: unknown[]): string {
  return items
    .map((raw, index) => {
      const item = raw as {
        "@id"?: string;
